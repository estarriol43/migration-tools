...
OUTPUT_DIR="./x86-sev-apache-multifd4"
...
QEMU_CMD="$QEMU_PATH/build/qemu-system-x86_64 \
    ...
    -object sev-guest,id=sev0,policy=0x00000,cbitpos=47,reduced-phys-bits=1 \
...
MIGRATION_PROPERTIES=(
    "migrate_set_parameter downtime-limit 28500"
...
function benchmark_setup() {
    ...
    $AB_BIN -c 100 -n 800000000000 -s 30000000 -g "$OUTPUT_DIR/ab$1" http://$GUEST_IP/ >&2 & 
    AB_PID=$!
...
function pre_migration() {
    ...
    python3 sev-setup.py --sev /mydata/nfs/ask_ark_rome.cert
    return 0
}
